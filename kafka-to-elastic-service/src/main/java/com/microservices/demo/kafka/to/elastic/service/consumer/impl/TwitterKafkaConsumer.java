...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public TwitterKafkaConsumer(KafkaListenerEndpointRegistry kafkaListenerEndpointRegistry,
                                ...
                                KafkaConfigData kafkaConfigData, KafkaConsumerConfigData kafkaConsumerConfigData, AvroToElasticModelTransformer avroToElasticModelTransformer, ElasticIndexClient<TwitterIndexModel> elasticIndexClient) {
    ...
    /**
     * Annotate with EventListener run when the application start.
     * Performing some checks on application start.
    * */
    @EventListener
    ...
    /**
     * Getting the "topic-name" var from the configuration file: config-client-kafka_to_elastic.yml
     * Getting the "consumer-group-id" var from the configuration file: config-client-kafka_to_elastic.yml
     * **/
    @Override
